...
def main():
    ...
    parser.add_argument('--model-path', type=str, default="./data/fashion")
    parser.add_argument('--pretrain-path', type=str, default="./data/fashion")
    ...
    if args.save_model:
        torch.save(model.state_dict(), "./output/fashion_mnist_cnn.pt")
